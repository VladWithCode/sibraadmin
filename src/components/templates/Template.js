  ...
  return (
    <div className="pb-5 project create template">
              ...
              {currentTemplate?._id === template._id ? (
                <>
                  ...
                  <label htmlFor={template.type}>
                    <div className="option">{template.type}</div>
                  </label>
                </>
              ) : (
                <>
      ...
      <div className="form-buttons">
        ...
        <button
          className="next"
          onClick={() => dispatch(templatesUpdate(currentTemplates))}
        >
          Guardar Cambios
        </button>
      </div>
      ...
      <div className="card mt-2">
        ...
        <div className="card__variables">
          {variables.sort().map((variable) => (
            <p onClick={handleCopy} id={variable} key={variable}>
              {variable}
            </p>
          ))}
        </div>
