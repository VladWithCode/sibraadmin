...
import { lotAddBinding, lotDeleteBinding, lotSetBindings } from '../../actions/lot';
    ...
    return (
        <div className="card edit">
            <div className="card__header">
                ...
                <button onClick={addBinding} className="add-ref">Agregar colindancia</button>
            </div>
                ...
                <div className="full">
                    {
                        currentBindings.map((binding, index) => (
                            <div key={index} className="card__body__item mt-2">
                                ...
                                <input id={`binding-${index}`} type="text" value={currentBindings[index]} onChange={inputChange} name={index} />
                                <button onClick={() => deleteBinding(index)} className="delete-area">
                                    &times;
                                </button>
                            </div>
                        ))
