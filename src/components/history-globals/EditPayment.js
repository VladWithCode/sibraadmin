...
export const EditPayment = ({ payment, hasChanged, index, extraCharge, extraChargeId }) => {
    ...
    return (
        ...
        <div className={`left ${index > 1 ? 'mt-3' : 'mt-2'} ${deletePayment && 'deleted'} ${hasChanged && 'changed'} `}>

            <div className="card__header">
                <h4>Pago</h4>
                <div onClick={changeDelete} className={`delete ${deletePayment && 'deleted'} `}>
                    {
                            ...
                            <div className="payment">
                                ...
                                <div className="card__body__item">
                                    ...
                                    <input
                                        ...
                                        type="date" name="date" value={formValues.date} />
                                </div>
                                <div className="card__body__item">
                                    <span>Cantidad</span>
                                    <input
                                        onChange={onInputChange}
                                        type="number" name="amount" value={formValues.amount} />
                                </div>
                            </div>
                        </>
                    )
                        ...
                        <>
                            <div className="payment">
                                ...
                                <div className="card__body__item">
                                    ...
                                    <input
                                        onChange={onInputChange}
                                        type="date" name="payedAt" value={formValues.payedAt} />
                                </div>
                                <div className="card__body__item">
                                    <span>Cantidad</span>
                                    <input
