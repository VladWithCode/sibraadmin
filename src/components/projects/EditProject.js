    ...
    if (isFormValid()) {
      ...
      if (req.status === "OK") {
        ...
        if (req2.status === "OK") {
          ...
          dispatch(
            setTempError("Hubo un problema al actualizar los tipos de lotes")
          );
        }
      } else {
        ...
        <div className="card__body">
          <div className="right">
            <div
              ...
              } ${hasChanged.includes("name") && "changed"}`}
            >
            ...
            <div
              ...
              } ${hasChanged.includes("associationName") && "changed"}`}
            >
            ...
            >
              ...
              <textarea
                className={`card__body__item ${
                  hasChanged.includes("description") && "changed"
                }`}
                name="description"
                value={description}
                onChange={(e) => {
          ...
          <div className="left">
            <div
              ...
              } ${hasChanged.includes("notary") && "changed"}`}
            >
            ...
            <div
              ...
              } ${hasChanged.includes("propertyScripture") && "changed"}`}
            >
            ...
            <div
              ...
              } ${hasChanged.includes("propertyBook") && "changed"}`}
            >
            ...
            <div
              ...
              } ${hasChanged.includes("scriptureDate") && "changed"}`}
            >
            ...
            <div
              ...
              } ${hasChanged.includes("constitutiveScripture") && "changed"}`}
            >
            ...
            <div
              ...
              } ${hasChanged.includes("constitutiveVolume") && "changed"}`}
            >
