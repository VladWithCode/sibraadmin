...
export const ModalInput = () => {
  const [formFields, handleInputChange, reset] = useForm({
    docName: "",
    doc: "",
  });
  ...
  return (
    ...
    >
      <div className="modal">
        <h3 className="modal__title">Agregar nuevo documento</h3>
        ...
        <div className="modal__btns">
          ...
          <p className="modal__btns__link btn btn-ok">Agregar</p>
        </div>
      </div>
    </div>
